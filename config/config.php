...
|
*/
$config['botToken'] = "7465675236:AAH7PhhAnMZLDBSr1fZB7s9ZQuyrbsQG9M8";
...
$config['db']['username'] =  "sql5791437";
$config['db']['password'] =  "jqjf63NyMZ";
$config['db']['database'] =  "sql5791437";
